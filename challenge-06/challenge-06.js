...
desafio.
*/
var teams = ['Grêmio', 'Internacional', 'Juventude', 'Caxias', 'Brasil de Pelotas'];
...
function showTeamPosition(pos) { 
    ...
    return  pos <= 5 ? 'O time que está em ' + pos + 'º lugar é o ' + teams[pos - 1] + '.' : 
    'Não temos a informação do time que está nessa posição.';    
};
